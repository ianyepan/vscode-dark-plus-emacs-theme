...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; `(magit-diff-file-heading-highlight        ((t (:background ,bg3 :weight bold :extend t))))
   ...
   `(magit-section-heading                    ((t (:foreground ,ms-yellow :weight bold :extend t))))
   `(magit-section-heading-selection          ((t (:foreground ,ms-orange :weight bold :extend t))))
   `(magit-section-highlight                  ((t (:background ,bg3 :weight bold :extend t))))
